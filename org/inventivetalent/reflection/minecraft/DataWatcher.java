...
/*     */ {
/*  42 */   public static ClassResolver classResolver = new ClassResolver();
/*  43 */   public static NMSClassResolver nmsClassResolver = new NMSClassResolver();
/*     */   
/*  45 */   public static Class<?> ItemStack = nmsClassResolver.resolveSilent(new String[] { "ItemStack" });
/*  46 */   public static Class<?> ChunkCoordinates = nmsClassResolver.resolveSilent(new String[] { "ChunkCoordinates" });
/*  47 */   public static Class<?> BlockPosition = nmsClassResolver.resolveSilent(new String[] { "BlockPosition" });
/*  48 */   public static Class<?> Vector3f = nmsClassResolver.resolveSilent(new String[] { "Vector3f" });
/*  49 */   public static Class<?> DataWatcher = nmsClassResolver.resolveSilent(new String[] { "DataWatcher" });
/*  50 */   public static Class<?> Entity = nmsClassResolver.resolveSilent(new String[] { "Entity" });
/*  51 */   public static Class<?> TIntObjectMap = classResolver.resolveSilent(new String[] { "gnu.trove.map.TIntObjectMap", "net.minecraft.util.gnu.trove.map.TIntObjectMap" });
/*     */   
/*  53 */   public static ConstructorResolver DataWacherConstructorResolver = new ConstructorResolver(DataWatcher);
/*     */   
/*  55 */   public static FieldResolver DataWatcherFieldResolver = new FieldResolver(DataWatcher);
/*     */   
/*  57 */   public static MethodResolver TIntObjectMapMethodResolver = new MethodResolver(TIntObjectMap);
/*  58 */   public static MethodResolver DataWatcherMethodResolver = new MethodResolver(DataWatcher);
/*     */   
...
/*     */   }
/*     */   
/*     */ public static class V1_11
/*     */   {
/* 124 */     static Class<?> DataWatcherItem = nmsClassResolver.resolveSilent(new String[] { "DataWatcher$Item" });
/* 125 */     static Class<?> DataWatcherObject = nmsClassResolver.resolveSilent(new String[] { "DataWatcherObject" });
...
/* 142 */       Map<Integer, Object> map = (Map)DataWatcherFieldResolver.resolve(new String[] { "c" }).get(dataWatcher);
...
/*     */       throws ReflectiveOperationException
/*     */     {
/* 153 */       return DataWatcherMethodResolver.resolve(new ResolverQuery[] { new ResolverQuery("d", new Class[] { DataWatcherObject }) }).invoke(dataWatcher, new Object[] { dataWatcherObject });
/*     */     }
/*     */     
/*     */     public static Object getValue(Object dataWatcher, Object dataWatcherObject) throws ReflectiveOperationException {
/* 157 */       return DataWatcherMethodResolver.resolve(new String[] { "get" }).invoke(dataWatcher, new Object[] { dataWatcherObject });
/*     */     }
/*     */     
...
/* 166 */       return DataWatcherItemFieldResolver.resolve(new String[] { "b" }).get(item);
/*     */     }
/*     */     
/*     */     public static int getItemIndex(Object dataWatcher, Object item) throws ReflectiveOperationException {
/* 170 */       int index = -1;
/* 171 */       Map<Integer, Object> map = (Map)DataWatcherFieldResolver.resolve(new String[] { "d" }).get(dataWatcher);
...
/* 184 */       Object serializer = DataWatcherObjectFieldResolver.resolve(new String[] { "c" }).get(object);
...
/* 200 */       return DataWatcherItemFieldResolver.resolve(new String[] { "d" }).get(item);
/*     */     }
/*     */     
/*     */     public static void setItemValue(Object item, Object value) throws ReflectiveOperationException {
/* 204 */       DataWatcherItemFieldResolver.resolve(new String[] { "c" }).set(item, value);
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */         try {
/* 306 */           this.type = new FieldResolver(nmsClassResolver.resolve(new String[] { className })).resolve(fieldNames).get(null);
/*     */         } catch (Exception e) {
...
/*     */         try {
/* 316 */           this.type = new FieldResolver(nmsClassResolver.resolve(new String[] { className })).resolveIndex(index).get(null);
/*     */         } catch (Exception e) {
...
/*     */       throws ReflectiveOperationException
/*     */     {
/* 153 */       return DataWatcherMethodResolver.resolve(new ResolverQuery[] { new ResolverQuery("c", new Class[] { DataWatcherObject }) }).invoke(dataWatcher, new Object[] { dataWatcherObject });
/*     */     }
/*     */     
/*     */     public static Object getValue(Object dataWatcher, Object dataWatcherObject) throws ReflectiveOperationException {
/* 157 */       return DataWatcherMethodResolver.resolve(new String[] { "get" }).invoke(dataWatcher, new Object[] { dataWatcherObject });
...
/*     */     public static int getItemIndex(Object dataWatcher, Object item) throws ReflectiveOperationException {
/* 170 */       int index = -1;
/* 171 */       Map<Integer, Object> map = (Map)DataWatcherFieldResolver.resolve(new String[] { "c" }).get(dataWatcher);
/* 172 */       for (Map.Entry<Integer, Object> entry : map.entrySet()) {
/* 173 */         if (entry.getValue().equals(item)) {
/* 174 */           index = ((Integer)entry.getKey()).intValue();
/* 175 */           break;
...
/*     */   {
/* 339 */     static Class<?> WatchableObject = nmsClassResolver.resolveSilent(new String[] { "WatchableObject", "DataWatcher$WatchableObject" });
...
/*     */       throws ReflectiveOperationException
/*     */     {
/* 346 */       return newWatchableObject(getValueType(value), index, value);
/*     */     }
/*     */     
...
/* 358 */       int type = getValueType(value);
/*     */       
/* 360 */       Object map = DataWatcherFieldResolver.resolve(new String[] { "dataValues" }).get(dataWatcher);
/* 361 */       TIntObjectMapMethodResolver.resolve(new ResolverQuery[] { new ResolverQuery("put", new Class[] { Integer.TYPE, Object.class }) }).invoke(map, new Object[] { Integer.valueOf(index), newWatchableObject(type, index, value) });
/*     */       
/* 363 */       return dataWatcher;
/*     */     }
/*     */     
/*     */     public static Object getValue(Object dataWatcher, int index) throws ReflectiveOperationException {
/* 367 */       Object map = DataWatcherFieldResolver.resolve(new String[] { "dataValues" }).get(dataWatcher);
/*     */       
/* 369 */       return TIntObjectMapMethodResolver.resolve(new ResolverQuery[] { new ResolverQuery("get", new Class[] { Integer.TYPE }) }).invoke(map, new Object[] { Integer.valueOf(index) });
/*     */     }
/*     */     
...
/* Location:              E:\Users\Edik\Minecraft\eclipse\spigot2\plugins\BossBarAPI_v2.4.1.jar!\org\inventivetalent\reflection\minecraft\DataWatcher.class
